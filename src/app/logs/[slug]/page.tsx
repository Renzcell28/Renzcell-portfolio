...
// ALL HARDCODED ACTIVITY LOGS - 61 Days OJT (Feb 4 - May 27, 2026)
const HARCODED_LOGS = [
  {
    "id": 1778919458900,
    "slug": "flowstate-13",
  ...
  },
  {
    ...
    "title": "Axiom Scrumban",
    "description": "A complete documentation that covers system features, recommendations, and implementation strategies. It also includes the development of core pages such as authentication pages and landing pages for a project management system using Laravel, Elasticsearch, and WebSockets.",
