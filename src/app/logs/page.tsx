...
// Hardcoded Activity Logs Data - All 61 logs (Feb 4 - May 27, excluding 2 Saturdays)
const HARCODED_LOGS: ActivityLog[] = [
  {
    ...
    date: "May 21, 2026",
    title: "FlowState",
    description: "Built a real-time notification system for teams and workstreams using Socket.IO, allowing users to receive instant popup messages across all pages without refreshing.",
    content: "*Real-Time Notification System\n  -Built a real-time notification system for teams and workstreams using Socket.IO, allowing users to receive instant popup messages across all pages without refreshing.\n\n*Styled Popup Notifications\n  -Designed styled popup notifications with user profile pictures, team/workstream names, message previews, timestamps, and notification sounds.\n\n*Fixed Notification Issues\n  -Fixed major notification issues such as duplicate popups, delayed messages, cross-team message mix-ups, and cases where users needed to send a message first before receiving notifications.",
  ...
  },
  {
    ...
    date: "May 20, 2026",
    title: "FlowState",
    description: "Implemented conditional Team Members tab visibility for admins only, with read-only profile fields for restricted users.",
    content: "*Conditional Team Members Tab Visibility\n  -Implemented conditional Team Members tab visibility for admins only, with read-only profile fields for restricted users.\n\n*Full Member Management\n  -Built full member management: edit details, reset passwords with validation, and toggle self-edit permissions per member.\n\n*Event-Driven System\n  -Created event-driven system with polling fallback to instantly reflect member name/email changes in sidebar without page refresh.\n\n*Secure Endpoints\n  -Developed 5 secure endpoints (update, reset-password, permissions, role, remove) with admin validation and team ownership checks.",
    tags: ["next.js"],
    icon: "👥"
  },
  {
    ...
    date: "May 19, 2026",
    title: "FlowState",
    description: "Created comprehensive User Manual documentation and built activity logs display with chatbot features.",
    content: "*Documents of FlowState\n  -Created comprehensive User Manual / User Guide documentation including instructions on how to use the system, system features and functionalities, and screenshots with detailed explanations for users.\n  -Designed and documented the System Architecture to illustrate the overall platform structure, including frontend, backend, database, API flow, and module interactions for workflow management and collaboration.\n\n*Portfolio Development\n  -Built activity logs display with search (title/description/tags), tag filter, month filter, and pagination (10 items per page)\n  -Designed chatbot with floating button featuring robot icon, pulsing ring, moving antenna, blinking eyes, and floating tooltip on 5-second cycles",
  ...
  },
  {
    ...
    date: "May 18, 2026",
    title: "FlowState",
    description: "Resolved deadline date and time fetching problems and built responsive dark theme portfolio.",
    content: "*FlowState Fixes\n  -Resolved the deadline date and time fetching problem in the Sprint Planner tab\n  -Regular tasks now properly display deadline dates and times in the \"REGULAR TASKS - BY PRIORITY\" table\n  -Fixed deadline display for blockers in the \"BLOCKERS PRIORITY\" section\n  -Fixed the Monitor Tab Functionality AND UI\n\n*Portfolio Development\n  -Built responsive dark theme portfolio with 10+ animations, reusable components (ProjectCard, ChatBot, AISummaryTool, ResumeSection), and OJT timeline featuring 18 milestones across 8 categories.\n  -Created 5 API routes with OpenRouter AI (5 model fallbacks)\n  -Designed questions that automatically retry five AI models to produce technical summaries of two to three sentences.",
    tags: ["next.js"],
    icon: "⚙️"
  },
  {
  ...
  },
  {
    ...
    date: "May 6, 2026",
    title: "🎉 TESDA NC II Assessment - PASSED! 🎉",
    description: "Successfully passed the TESDA NC II assessment, demonstrating competency in required technical skills. Officially NCII Certified! ✅",
  ...
  },
  {
    ...
    content: "*Learning Progress\n  -Continued learning Laravel + Vue integration\n  -Waiting for GitHub access approval in AxionHR to proceed with repository work",
    tags: ["Laravel", "Vue"],
    icon: "📚"
  },
  {
    ...
    content: "*Learning Progress\n  -Learning Laravel plus Vue\n  -SUI Modules 3, 4, and 5 in progress",
    tags: ["Laravel", "Vue"],
    icon: "🔗"
  },
  {
...
// OJT Timeline Data - Updated with 61 days OJT (Feb 4 - May 27)
const ojtTimeline = [
  {
    date: "Feb 4, 2026",
    title: "🎯 OJT Started!",
    description: "Started OJT at MakerSpace Innohub. Began reading SUI Modules 1-5. Started learning Laravel + Vue.js integration.",
    icon: "🚀",
    category: "Start"
  },
  {
    date: "Feb 5-6, 2026",
    title: "Laravel + Vue Learning",
    description: "Continued learning Laravel and Vue.js fundamentals. Worked on SUI Modules 3-5.",
    icon: "📚",
    category: "Learning"
  },
  {
    date: "Feb 15-20, 2026",
    title: "Axiom Scrumban Development",
    description: "Built Axiom Scrumban pages and notification system with 3-day reminders, due today alerts, overdue alerts, and instant in-app notifications.",
    icon: "💻",
    category: "Development"
  },
  {
    date: "Feb 23-25, 2026",
    title: "Axiom Scrumban - Bug Fixes & Support",
    description: "Implemented permanent project deletion. Configured Gmail SMTP. Resolved 404 errors, PostgreSQL issues, route conflicts. Assisted with heat press transfer printing.",
    icon: "⚙️",
    category: "Bug Fix"
  },
  {
    date: "Feb 26-27, 2026",
    title: "SyncSnap Research",
    description: "Performed QA testing on Sinag Villas Website. Researched Node.js and evaluated tools for SyncSnap project.",
    icon: "🔍",
    category: "Research"
  },
  {
    date: "March 1-5, 2026",
    title: "SyncSnap - Gamification & Workspace",
    description: "Implemented daily streaks, early bird bonuses (+10 points), milestone rewards, and leaderboard rankings. Created database tables.",
    icon: "🎮",
    category: "Development"
  },
  {
    ...
    description: "Implemented blocker status management (Pending/Processing/Resolved). Built email notification system with admin-to-member threading. Added workspace search.",
    icon: "🔒",
    category: "Development"
  },
  {
    ...
    description: "Integrated Gemini API for AI report generation. Built deadline reminders with email notifications. Added date picker for custom ranges. Set up OpenRouter backup.",
    icon: "🤖",
  ...
  },
  {
    ...
    description: "Built MemberReport dashboard. Implemented role-based access control and IDOR protection. Added Reports Search feature.",
    icon: "📈",
    category: "Security"
  },
  {
    ...
    description: "Reviewed SOP for page creation. Started page template setup. Created vehicle comparison design template for Chevrolet vs Toyota.",
    icon: "🎨",
    category: "Design"
  },
  {
    ...
    description: "Added Delete Account with confirmation modal, Change Password with password fields. Profile photos in assignee dropdown. Fixed API call for user deletion. Created one-page pitch.",
    icon: "🔐",
    category: "Security"
  },
  {
    ...
    description: "Cloned repository, installed dependencies, configured environment variables. Connected to MongoDB Atlas.",
    icon: "🌊",
    category: "Setup"
  },
  {
    date: "April 13-17, 2026",
    title: "FlowState - UI & Settings",
    description: "Set up AI Insight page with custom date ranges. Created Settings page with Profile/Security/Preferences tabs. Added team selection and AI Analytics navigation.",
    icon: "⚙️",
    category: "Development"
  },
  {
  ...
  {
    date: "April 20, 2026",
    title: "FlowState - UI Enhancements",
    description: "Updated Floating Action Button to only show on Dashboard. Started Blockers UI design. Added 'No Team' message across all pages.",
    icon: "🎨",
    category: "UI/UX"
  },
  {
    ...
    description: "Started TESDA NCII CSS training. Focused on training modules and assessment preparation. Completed hands-on practical activities.",
    icon: "📖",
    category: "Training"
  },
  {
  ...
  {
    date: "May 7-12, 2026",
    title: "FlowState - Workstream & Auth Features",
    description: "Added workstream/team rename with real-time sync. Built secure signup with password meter. Login backend with bcrypt. Custom FlowState branding.",
    icon: "🔄",
    category: "Development"
  },
  {
    date: "May 13-14, 2026",
    title: "FlowState - Priority & AI Features",
    description: "Added Priority Tasks and Blocker Priority views. Enhanced Sprint Planner with workload balancing. Integrated Google Gemini AI.",
    icon: "🤖",
    category: "AI Integration"
  },
  {
    date: "May 18-21, 2026",
    title: "FlowState - Final Features & Portfolio",
    description: "Fixed deadline display issues. Built responsive dark theme portfolio with 10+ animations and chatbot. Created real-time notification system with Socket.IO.",
    icon: "✨",
    category: "Development"
  }
];
    ...
    <div className="container mx-auto px-4 py-16 min-h-screen relative pb-32 bg-black">
      ...
      <div className="max-w-4xl mx-auto mb-10 space-y-6">
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-1">
                ...
                <div className="flex items-center gap-1.5 text-xs text-gray-500">
                  ...
                  <span>OJT Period: Feb 4 - May 27, 2026 (61 Days)</span>
                </div>
                <a 
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-2">
          ...
          <div className="text-center p-3 rounded-lg bg-gray-900/50 border border-gray-800">
            <p className="text-2xl font-bold text-red-500">61</p>
            <p className="text-xs text-gray-500">OJT Days</p>
          </div>
          <div className="text-center p-3 rounded-lg bg-gray-900/50 border border-gray-800">
                    ...
                    <div className={`relative h-full bg-gray-900/80 backdrop-blur-sm rounded-xl border overflow-hidden hover:shadow-xl transition-all duration-300 ${
                      ...
                      <div className={`px-4 py-2 border-b ${
                        ...
                        <div className="flex items-center justify-between">
                          <span className={`text-xs font-bold ${
                            event.title.includes("PASSED") ? 'text-yellow-500' : 
                            event.title.includes("Started") ? 'text-green-500' : 'text-red-500'
                          }`}>
                            {event.date}
                          </span>
                      ...
                      <div className="p-4">
                        <h3 className={`font-headline font-bold text-sm md:text-base mb-2 line-clamp-2 ${
                          event.title.includes("PASSED") ? 'text-yellow-500' : 
                          event.title.includes("Started") ? 'text-green-500' : 'text-white'
                        }`}>
                          {event.title}
                        </h3>
